...
from peft.mapping import PEFT_TYPE_TO_CONFIG_MAPPING, PEFT_TYPE_TO_PREFIX_MAPPING, PEFT_TYPE_TO_TUNER_MAPPING
...
from .tuners.config import LoraConfig
from .tuners.model import LoraModel as HiraModel
    ...
    **Attributes**:
    ...
    def __init__(
        ...
        if self._is_prompt_learning:
            ...
            if isinstance(peft_config, LoraConfig) and peft_config.use_hira:
                print("HiRA Model is Adopted!")
                cls = HiraModel
            else:
                print("HiRA Model is NOT Adopted!")
