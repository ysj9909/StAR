...
STAGE1_LORA_CHECKPOINT=YOUR_STAGE1_CHECKPOINT_PATH  # e.g., star_workdir/StAR_Qwen2.5VL7B_.../global_step_XXX/actor/lora_adapter
# ------------------------
